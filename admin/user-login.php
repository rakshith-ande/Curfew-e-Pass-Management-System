<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
            $user="";
            $sql = "select * from users where UserName='".$name."' and Password='".$pwd."' and type='normal user'";
            ...
            if($result->num_rows==1)
            {
                ...
                $_SESSION['user']=$user;
                header("Location: ./add-user-pass.php");
            }
            else
            {
...
<head>
    <title>Curfew Pass Management System | UserLogin Page</title>
                        ...
                        <div class="ui Field">
                        	<div class="ui stackable grid">
                        		...
                        		<div class="five wide column">
                           			<a href="./forgot-user-password.php">Lost password?</a>
                        		</div>
