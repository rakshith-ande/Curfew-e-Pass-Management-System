...
<html>
<head>
	<title>Curfiew E-Pass Management System | Userwise passes</title>
              ...
              if($result->num_rows>0)
              {
                      ...
                      while($row=$result->fetch_assoc())
                      {
                          ...
                          <tr>
                              ...
                              <td>
                                  <button class='ui blue button' onclick='viewpasses($id)'>view passes</button>
                              </td>
                          </tr>
...
<script>
    function viewpasses(id)
    {
        location.href="particular-user-passes.php?view_user="+id;
    }
</script>